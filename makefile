...
LFLAGS += -use-dynld -lSDL2 -mcrt=newlib -ggdb -lm
endif
...
LFLAGS += -mwindows -lmingw32 -lSDL2main -lSDL2 -lm
...
LFLAGS += -nostdlib -Wl,--file-alignment,0x20 -Wl,--section-alignment,0x20 -shared --Wl,--entry,_WinMainCRTStartup -Wl,--strip-all -L/usr/local/openxdk/i386-pc-xbox/lib -L/usr/local/openxdk/lib -lSDL2 -lopenxdk -lhal -lc -lm -lhal -lusb -lc -lxboxkrnl
endif

# Openserver 5.x
ifeq ($(PLATFORM),openserver5)
LFLAGS += -lSDL2 -lm -lX11 -lXext -lsocket
endif

# Openserver 6.x
ifeq ($(PLATFORM),openserver6)
LFLAGS += -lSDL2 -lm -lthread
endif
...
LFLAGS += -lSDL2 -lpthread -laa -lncurses -lm
...
LFLAGS += -lSDL2 -lm -lrt -lpthread -lusbhid -lossaudio
...
LFLAGS += -lSDL2 -lm -lX11 -lXext -lrt -lpthread -lusbhid -lossaudio
...
LFLAGS += -lSDL2 -lrt -lpthread -laa -lusbhid -lncurses -lossaudio -lm
...
LFLAGS += -lSDL2 -lm -lX11 -lXext -lXau -lXdmcp -lusbhid -lpthread
...
LFLAGS += -static -lSDL2 -lm -lX11 -lXext -lpthread -lusbhid
...
# QNX 6.x
ifeq ($(PLATFORM),qnx6)
LFLAGS += -lSDL2 -lm -lph -lasound
endif

# Atari Mint
ifeq ($(PLATFORM),mint)
LFLAGS += -lSDL2 -lm -lgem
endif

# Alpha Linux cross compile
ifeq ($(PLATFORM),alpha-linux-cross)
LFLAGS += -lSDL2 -lm -lX11 -lXext -lpthread -ldl -lasound
...
LFLAGS += -lSDL2 -lm -lX11 -lXext -lpthread -ldl
...
LFLAGS += -lSDL2 -lm -lX11 -lXext -lpthread -ldl -lasound -lgcc
...
LFLAGS += -lSDL2 -lm -lX11 -lXext -lpthread -ldl -lasound -lX11-xcb
...
LFLAGS += -L/usr/local/pspdev/psp/sdk/lib -lSDL2  -lm -lpspdebug -lpspgu -lpspctrl -lpspge -lpspdisplay -lpsphprm -lpspsdk -lpsprtc -lpspaudio -lc -lpspuser -lpsputility -lpspkernel -lpspnet_inet
CC = psp-gcc
endif
...
LFLAGS += -L/boot/develop/lib/ppc /boot/develop/lib/ppc/glue-noinit.a /boot/develop/lib/ppc/init_term_dyn.o /boot/develop/lib/ppc/start_dyn.o -lbe -lroot -lSDL2
CC = mwccppc
endif
...
LFLAGS += -static -lSDL2 -lpthread -lm -msoftfloat -mcpu=arm920t
CC=arm-linux-gcc
endif
...
CFLAGS += -D__SWITCH__ -D__EMBED_TUNES__ `$(DEVKITPRO)/portlibs/switch/bin/sdl2-config --cflags` -D__NO_MOUSE__
LFLAGS += -specs=$(DEVKITPRO)/libnx/switch.specs `$(DEVKITPRO)/portlibs/switch/bin/sdl2-config --libs` -lm -lstdc++
APP_TITLE = Planet Hively
APP_AUTHOR = IRIS/Up Rough
endif
...
switch_nro:
	nacptool --create "Planet Hively" "IRIS/Up Rough" "1.0.0" planethively.nacp
	elf2nro planethively planethively.nro --nacp=planethively.nacp
